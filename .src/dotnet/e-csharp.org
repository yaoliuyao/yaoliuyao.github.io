...
#+begin_src cs
  ...
  class Program
  {
      static void Main(string[] args)
      {
          ...
          {
              Console.WriteLine("hahahaahaha, wo de 爱的委托 {0}", sum);
          };
          MyAdd(1, 3, maw);
...
#+begin_src cs
  class Program
  {
      static void Main(string[] args)
      {
          WithGraphic(@"e:\hello333.jpg", g =>
          {
              g.DrawString("wqwww", new Font("Aria", 46), Brushes.Aqua, 0, 300);
              g.DrawString("Hello", new Font("Monospace", 26), Brushes.DarkGreen, 10, 10);
          }, 500, 500);
  
          WithGraphic(@"e:\hello4444.jpg", pen =>
          {
      ...
      static void WithGraphic(string file, Action<Graphics> act, int width = 256, int height = 256)
      {
          if (File.Exists(file))
          {
