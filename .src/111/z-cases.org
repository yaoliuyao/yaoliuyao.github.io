...
#+begin_src csharp -n 210
  public void PrintFantasy()
  {
      ...
      while(true)
      {
          ...
          {
              PrintToConsoleWithColor(ConsoleColor.Red);
          }
          else if (key.Key == ConsoleKey.D2)
          {
              PrintToConsoleWithColor(ConsoleColor.Green);
          }
          else if (key.Key == ConsoleKey.D3)
          {
              PrintToConsoleWithColor(ConsoleColor.Yellow);
          }
          else if(key.Key == ConsoleKey.Enter)
          {
              ...
              while (true)
              {
                  ...
                  PrintToConsoleWithColor(colors[i]);
                  Thread.Sleep(300);
              }
          }
          else
  ...
  public void PrintToConsoleWithColor(ConsoleColor color)
  {
