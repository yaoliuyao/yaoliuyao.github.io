...
#+begin_src csharp -n
  public void ExportToExcel3()
  {
      ...
      style1.BorderBottom = NPOI.SS.UserModel.BorderStyle.Double;
      ...
      style2.FillPattern = NPOI.SS.UserModel.FillPattern.NoFill;
      style2.FillBackgroundColor = NPOI.HSSF.Util.HSSFColor.Green.Index;
...
#+begin_src csharp -n
  public void ExportToExcel3()
  {
      ...
      style.BottomBorderColor = NPOI.HSSF.Util.HSSFColor.Green.Index;
