...
#+begin_src csharp
  class ElectricBillCalc
  {
      ...
      public static readonly int[] WinnerLevels = { 200, 400 };
      ...
      public double Lv1Cost { get => _LvUsed[0] * Rates[0]; }
      public double Lv2Cost { get => _LvUsed[1] * Rates[1]; }
      public double Lv3Cost { get => _LvUsed[2] * Rates[2]; }
