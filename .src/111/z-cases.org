...
#+begin_src csharp
  ...
  {
      // 基准数据
      public static readonly int[] SummerLevels = new int[] { 260, 600 };
      public static readonly int[] WinnerLevels = new int[] { 200, 400 };
      public static readonly double[] LevelRates = new double[] { 0.600, 0.650, 0.900 };
      ...
      public double Lv1Cost { get => _LvUsed[0] * LevelRates[0]; }
      public double Lv2Cost { get => _LvUsed[1] * LevelRates[1]; }
      public double Lv3Cost { get => _LvUsed[2] * LevelRates[2]; }
      public double TotalCost { get => Lv1Cost + Lv2Cost + Lv3Cost; }
      ...
      {
          (int p1, int p2) = IsSummer() ? (SummerLevels[0], SummerLevels[1]) : (WinnerLevels[0], WinnerLevels[1]);

          if (_used <= p1)
          {
              _LvUsed = new double[] { _used, 0, 0 };
          }
          else if (_used <= p2)
          {
              _LvUsed = new double[] { p1, _used - p1, 0 };
          }
          else
          {
              _LvUsed = new double[] { p1, p2 - p1, _used - p2 };
          }
      }
      ...
      public void PrintToConsole()
      {
          ...
          Console.WriteLine("".PadRight(30, '┈'));
          Console.WriteLine($"总计: {TotalCost,10:C} ");
      }
