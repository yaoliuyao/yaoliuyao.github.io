...
根据分析，初步代码:
#+begin_src csx
  string s = "hello, world, How are You. How Do You do.";
  Console.WriteLine(Rot13(s));
  Console.WriteLine(Rot13(Rot13(s)));
...
#+begin_src csx :results pp
   // Console.WriteLine(RotChar('a')); // 'n'
   // Console.WriteLine(RotChar('n')); // 'a'
   // Console.WriteLine(RotChar('A')); // 'N'
   // Console.WriteLine(RotChar('N')); // 'A'
   string s = "hello, world, How are You. How Do You do.";
   Console.WriteLine(Rot13(s));
...
2. 可以将加密的命令添加到注册表，从而方便使用。比如，将下面语句保存为 .reg 格式，然后双击导入:
   #+begin_src conf
     ...
     [HKEY_CLASSES_ROOT\*\shell\EncWithRot13]
     
     [HKEY_CLASSES_ROOT\*\shell\EncWithRot13\command]
