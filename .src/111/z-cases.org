...
#+begin_src csharp -n
  ...
  namespace Nfit161
  {
      class Calculator
      {
          ...
          public virtual IRow ExportToHead(ISheet sheet)
          {
              return ExcelHelper.CreateRowForSheet(sheet, 0, GetHeads());
          }

          public virtual IRow ExportToBody(ISheet sheet)
          {
              return ExcelHelper.CreateRowForSheet(sheet, sheet.LastRowNum + 1, GetValues());
          }

          public virtual void ExportToExcel(string fileName)
          {
              IWorkbook workbook = ExcelHelper.OpenOrCreateWorkbook(fileName);
              ISheet sheet = workbook.GetSheetAt(0);
              ...
              // 保存
              ExcelHelper.SaveAndCloseWorkbook(workbook, fileName);
          }
      }
      ...
      class TipCalc : Calculator
      {
          ...
          public override IRow ExportToHead(ISheet sheet)
          {
              ...
              style.FillForegroundColor = NPOI.HSSF.Util.HSSFColor.Green.Index;
              style.FillPattern = FillPattern.Diamonds;
              ExcelHelper.SetStyleForRow(row, style);
              return row;
          }
      ...
      class ElectricBillCalc : Calculator
      {
          ...
          public double Lv1Cost => lvUsed[0] * Rates[0];
          public double Lv2Cost => lvUsed[1] * Rates[1];
          public double Lv3Cost => lvUsed[2] * Rates[2];
          ...
          public override string[] GetHeads() => new[] { "月", "量", "费用" };
          public override string[] GetValues() => new[] { _month.ToString(), _used.ToString(), Bill.ToString() };
      }
  }
#+end_src
