...
#+begin_src csharp -n
  ...
  namespace Nfit161
  {
      ...
      abstract class CalculatorGeneral : ICalculator
      {
          public abstract void Help();
          public abstract void PrintToConsole();
      ...
      class TipCalculator : CalculatorGeneral
      {
      ...
      class TaxCalculator : CalculatorGeneral
      {
          public override void Help()
          {
          }
      ...
      class ElectricBillCalculator : CalculatorGeneral
      {
          public override void Help()
          {
          }
