...
#+begin_src csharp -n
  class 电费计算
  {
      ...
      public double 第二档电费 { get => _阶梯度数[0] * 档费[0]; }
      public double 第三档电费 { get => _阶梯度数[0] * 档费[0]; }
      public double 总电费 { get => 第一档电费 + 第二档电费 + 第三档电费; }

      // 基准数据
      public static readonly double[] 档费 = new double[] { 0.600, 0.650, 0.900 };

      public void 设置月份和电数 (int month, double amount)
      {
      ...
      public void 计算阶梯度数()
      {
          ...
          else
          {
              ...
              {
                  _阶梯度数 = new double[] { 200, 400 - 260, _电数 - 400 };
              }
          }
      }
